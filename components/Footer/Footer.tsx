...
export default function Footer() {
  ...
  return (
    <div
      className={`flex h-[10rem] w-full items-center justify-between px-[14rem] sm:h-full sm:flex-col sm:gap-[1.2rem] sm:px-0 md:px-[4rem] ${theme === 'normal' ? 'bg-var-white' : 'bg-var-black2'}`}
    >
      <p
