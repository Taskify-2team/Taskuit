...
export default function UserProfile({ profileImageUrl, nickname, size = 'l' }: UserProfileProps) {
  ...
  return profileImageUrl ? (
    ...
    <div
      className={`flex shrink-0 items-center justify-center rounded-full border-2${theme === 'normal' ? 'border-gray-300' : 'border-var-black2'} bg-gray-500 font-bold text-white shadow-md`}
