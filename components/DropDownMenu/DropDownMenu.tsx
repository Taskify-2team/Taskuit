        ...
        <div className="absolute left-0 top-[5rem] flex w-full animate-slideDown flex-col overflow-hidden rounded-md border border-solid border-gray-300 bg-white py-[0.65rem] shadow-lg">
          {menuList.map((menuItem) => (
            <div
              ...
              className="border-1 relative grid h-full w-full grid-cols-[2.2rem_1fr] place-items-start content-center gap-1 border-solid border-blue-500 px-[1.6rem] py-[0.65rem] hover:bg-slate-200"
            >
              {menuItem === selectMenu && (
