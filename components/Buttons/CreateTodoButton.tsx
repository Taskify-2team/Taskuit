...
export default function CreateTodoButton({ onClick }: CreateTodoButtonProps) {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`flex h-[4rem] w-[100%] cursor-pointer items-center justify-center rounded-[0.6rem] border-[0.1rem] border-solid hover:border-var-blue lg:w-[31.4rem] ${theme === 'normal' ? 'border-var-gray3 bg-var-white' : 'border-var-black2 bg-var-black2'}`}
    >
