...
export default function CreateColumnButton({ onClick }: ButtonHTMLAttributes<HTMLButtonElement>) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex h-[7rem] w-[54.4rem] cursor-pointer items-center justify-center gap-[1.2rem] rounded-[0.6rem] border border-solid border-var-gray3 bg-var-white lg:w-[35.4rem]"
    >
