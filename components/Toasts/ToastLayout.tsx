...
export default function ToastLayout() {
  ...
  return (
    <div
      className={`${isVisible ? 'animate-slideDown' : 'animate-slideUp'} fixed right-[2.5rem] top-[2.5rem] z-20 flex h-[6rem] w-[28rem] items-center justify-between gap-[1.5rem] overflow-hidden rounded-[0.6rem] border-[0.1rem] border-var-gray2 bg-var-white px-[2rem] py-[2rem] shadow-lg`}
    >
      <div
